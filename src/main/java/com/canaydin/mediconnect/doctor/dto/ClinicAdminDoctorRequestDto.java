...
public record ClinicAdminDoctorRequestDto(

        @NotBlank(message = "Doctor full name cannot be empty")
        @Size(
                min = 2,
                max = 100,
                message = "Doctor full name must be between 2 and 100 characters"
        )
        String fullName,
        ...
        @Size(
                max = 100,
                message = "Specialty must be at most 100 characters"
        )
        String specialty,
        ...
        @Max(
                value = 70,
                message = "Experience years cannot be greater than 70"
        )
